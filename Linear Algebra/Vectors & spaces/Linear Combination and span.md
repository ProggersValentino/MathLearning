...
if we multiply $\vec{a}$ and $\vec{b}$ by $C$ scalar then we can get any set of numbers within $R^2$ if the vectors $\vec{a}$ and $\vec{b}$ are [linearly independent](Linear%20Independence). 
$C = [2, 1]$
